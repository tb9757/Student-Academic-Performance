...
This hypothesis addresses the importance of being consistently in school versus performing well in internal assessments. It compares engagement and consistency with academic ability and prior knowledge.
...
-   The performance of both models will be compared using standard regression metrics such as R², Mean Absolute Error (MAE), and Root Mean Squared Error (RMSE).
...
More interesting analysis could have been done if the dataset also contained more columns. More information about the pupils, their background, their parents, and other factors that may have an impact on their final exam marks. As it is, the information is fairly limited.
...
High-level explanations and conclusions provide technical insight for interested parties. Technical and non-technical elements found on all pages.
